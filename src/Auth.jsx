  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (mode === "register") {
        ...
        const res = await axios.post("https://otabek.alwaysdata.net/register", {
        ...
        const res = await axios.post("https://otabek.alwaysdata.net/login", {
          email: form.email,
          password: form.password,
        });
        ...
        const userRes = await axios.get(`https://otabek.alwaysdata.net/user/${userId}`);
